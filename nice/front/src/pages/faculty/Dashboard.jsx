    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50/30 to-gray-50 flex">
      ...
      <div className="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Welcome back! Manage your travel and passes.</p>
        </div>
            ...
            {pass ? (
              ...
              <div className="text-center py-8">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg font-semibold"
                >
                  Get a Pass
                </button>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <button
            ...
            className="group bg-gradient-to-br from-indigo-600 to-indigo-700 text-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 text-left transform hover:scale-[1.02] border border-indigo-500/50"
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold">Book Ticket</h3>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold">My Pass</h3>
            </div>
